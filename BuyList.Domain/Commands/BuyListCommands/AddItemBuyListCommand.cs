...
{
    public class AddItemBuyListCommand : Notifiable, ICommand
    {
        public Guid OwnerId { get; set; }
        public Guid ItemId { get; set; }
        public Guid BuyListId { get; set; }

        public AddItemBuyListCommand() { }

        public AddItemBuyListCommand(Guid ownerId, Guid itemId, Guid buyListId)
        {
            OwnerId = ownerId;
            ItemId = itemId;
            BuyListId = buyListId;
